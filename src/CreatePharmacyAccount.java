...
public class CreatePharmacyAccount extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CreatePharmacyAccount() {
		super("Create Pharmacy Account");
		...
		JLabel lblLastName = new JLabel("License ID No.");
		lblLastName.setBounds(46, 60, 91, 16);
		...
		textField.setBounds(139, 27, 164, 28);
